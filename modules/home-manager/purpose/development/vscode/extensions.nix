...
merge
  (merge
    (merge
      (merge
      {
        ...
        "eamodio"."gitlens" = vscode-utils.extensionFromVscodeMarketplace {
          ...
          publisher = "eamodio";
          version = "2025.2.2804";
          sha256 = "0rqv3xgk6f46afzzjns6ysssgmczg33i1l5d4f9qfqa2qknjhf0n";
        ...
        (lib.attrsets.optionalAttrs (isLinux && (isi686 || isx86_64)) {
          ...
          "rust-lang"."rust-analyzer" = vscode-utils.extensionFromVscodeMarketplace {
            ...
            publisher = "rust-lang";
            version = "0.4.2323";
            sha256 = "1sinssz59whnzy27lp0caskwr90w0qdw98dkybk8yi97cmq35xj3";
            arch = "linux-x64";
      ...
      (lib.attrsets.optionalAttrs (isLinux && (isAarch32 || isAarch64)) {
        ...
        "rust-lang"."rust-analyzer" = vscode-utils.extensionFromVscodeMarketplace {
          ...
          publisher = "rust-lang";
          version = "0.4.2323";
          sha256 = "1f841rh2fip1wvcbh12nhdzr4iwnznmg3dyc6z44knbr0sv2ch6x";
          arch = "linux-arm64";
    ...
    (lib.attrsets.optionalAttrs (isDarwin && (isi686 || isx86_64)) {
      "rust-lang"."rust-analyzer" = vscode-utils.extensionFromVscodeMarketplace {
        ...
        publisher = "rust-lang";
        version = "0.4.2323";
        sha256 = "0k0hisnv2yn3cyxnpqn2qlipda4kibzxfqrwjv2jpbylr4fp59b5";
        arch = "darwin-x64";
  ...
  (lib.attrsets.optionalAttrs (isDarwin && (isAarch32 || isAarch64)) {
    "rust-lang"."rust-analyzer" = vscode-utils.extensionFromVscodeMarketplace {
      ...
      publisher = "rust-lang";
      version = "0.4.2323";
      sha256 = "17nw1ihafw7n0phnaayb3sr3sg7967b5c5w4v35vmr5nvy482mdx";
      arch = "darwin-arm64";
