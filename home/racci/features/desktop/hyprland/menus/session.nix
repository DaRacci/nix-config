...
}:
{
  ...
  programs.wlogout = {
    ...
    style =
      ...
      in
      ''
        @define-color text-colour ${palette.base00};
        @define-color alt-text-colour ${palette.base01};
        @define-color select-on-bg ${palette.base0E};
        @define-color select-off-bg ${palette.base0D};
        @define-color alt-select-on-bg ${palette.base09};
        @define-color alt-select-off-bg ${palette.base02};
        @define-color list-select-bg ${palette.base0D};
        @define-color list-unselect-bg ${palette.base03};
